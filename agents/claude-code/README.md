...
docker run --rm -it -v $(pwd):/app -v $HOME/.claude:/home/ubuntu/.claude -v $HOME/.claude/.claude.json:/home/ubuntu/.claude.json -e ANTHROPIC_API_KEY=$ANTHROPIC_API_KEY claude-code --verbose --dangerously-skip-permissions
```
